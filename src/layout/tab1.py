...
def update_table_stats(eq_index, params):
    with h5py.File(
        ...
        data_scalars = f[
            "/scalars"
        ]  ## This is a group, with attributes corresponding to the values
        ...
        hover_list += [
            {
                "Parameter": {"value": "Number of field periods", "type": "markdown"},
                "Value": None,
            }
        ]
        ...
        for q in params.attrs_scalars:
            ...
            hover_list += [
                {"Parameter": {"value": text, "type": "markdown"}, "Value": None}
            ]
